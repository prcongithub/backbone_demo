...
module BackboneDemo
  class Application < Rails::Application
    ...
    if Rails.env == 'development'
			...
			config.action_mailer.default_url_options = { :host => "backbonedemo.truespider.org", :only_path => false, :protocol => "http" }
			config.action_controller.asset_host = "http://backbonedemo.truespider.org"
			config.action_mailer.asset_host = "http://backbonedemo.truespider.org"
		else
			config.action_mailer.default_url_options = { :host => 'backbonedemo.truespider.org', :only_path => false, :protocol => "http" }	
			config.action_controller.asset_host = "http://backbonedemo.truespider.org"
			config.action_mailer.asset_host = "http://backbonedemo.truespider.org"
